...
<div class="topnav">
    <a href="profile.php" > Recently Post</a>
    <a href="update.php" class = "active"> My Profile </a>
...
<form action="/action_page.php" style="border:1px solid #ccc">`
  <div class="container">
    ...
    <br>
    <hr>
   <h2><center> My ICpEP Profile  </center></h2>
 ...
 <Label><b> Membership Classification :</b></Label> &nbsp
   ...
   <br> 
    ...
    <p>By updating this account you agree to our <a href="#" style="color:dodgerblue"> Qualification and Procedure</a> of this organization.</p>
